...
def tar_to_xyz(tarpath, dest):
    ...
    with open(os.path.join(DATADIR, "qm9.xyz"), "wb") as f:
        for tarinfo in tar:
...
if __name__ == "__main__":
    ...
    filename = os.path.join(DATADIR, "dsgdb9nsd.xyz.tar.bz2")
    xyz_name = os.path.join(DATADIR, "qm9.xyz")
    final_dest = os.path.join(DATADIR, "qm9.db")
